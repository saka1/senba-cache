...
Inputs:  docs/reports/data/2026-05-08-c11s-sweep.csv
Outputs: docs/reports/data/2026-05-08-c11s-{metric}-{op_mix}.png
         docs/reports/data/2026-05-08-c11s-summary.csv
"""
...
DATA = ROOT / "docs" / "reports" / "data" / "2026-05-08-c11s-sweep.csv"
OUTDIR = ROOT / "docs" / "reports" / "data"

VARIANTS = ["c8", "c10s", "c11s"]
COLORS = {"c8": "#1f77b4", "c10s": "#2ca02c", "c11s": "#9467bd"}
MARKERS = {"c8": "o", "c10s": "^", "c11s": "D"}
...
def main() -> None:
    ...
    grp.to_csv(OUTDIR / "2026-05-08-c11s-summary.csv", index=False)
    ...
    for op_mix in op_mixes:
        for metric, ylabel, fname_tag in [
            ...
            fig.tight_layout()
            out = OUTDIR / f"2026-05-08-c11s-{fname_tag}-{op_mix}.png"
