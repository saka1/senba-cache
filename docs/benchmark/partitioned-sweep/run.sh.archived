#!/usr/bin/env bash
# `senba::concurrent::PartitionedCache` の (T × N) sweep。c17s baseline と r1 を
# 同枠比較する。設計: `docs/reports/2026-05-12-partitioned-design.md`。
#
# 主成果物は `data/results.csv` (plot.py が pareto / heatmap / scalability 図に変換)。
#
# # Stages
...
HERE="docs/benchmark/partitioned-sweep"
DATA="$HERE/data"
mkdir -p "$DATA"
